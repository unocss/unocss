...
<div class=":uno: text-center sm:text-left foo">
  <div class=":uno: text-sm font-bold hover:text-red"/>
    ...
    expect(result.css).toMatchInlineSnapshot(`
      "/* layer: shortcuts */
      .uno-pe1esh{--un-bg-opacity:1;background-color:rgba(239,68,68,var(--un-bg-opacity));border-width:1px;border-style:solid;--un-border-opacity:1;border-color:rgba(229,231,235,var(--un-border-opacity));font-weight:700;--un-scale-x:0.05;--un-scale-y:0.05;transform:translateX(var(--un-translate-x)) translateY(var(--un-translate-y)) translateZ(var(--un-translate-z)) rotate(var(--un-rotate)) rotateX(var(--un-rotate-x)) rotateY(var(--un-rotate-y)) rotateZ(var(--un-rotate-z)) skewX(var(--un-skew-x)) skewY(var(--un-skew-y)) scaleX(var(--un-scale-x)) scaleY(var(--un-scale-y)) scaleZ(var(--un-scale-z));font-size:1.25rem;line-height:1.75rem;}
      .uno-cbgd7b{text-align:center;}
      .uno-s9yxer{font-weight:700;font-size:0.875rem;line-height:1.25rem;}
