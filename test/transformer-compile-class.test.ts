...
<div class=":uno: text-center sm:text-left foo">
  <div class=":uno: text-sm font-bold hover:text-red"/>
    ...
    expect(result.css).toMatchInlineSnapshot(`
      ":root{--un-scale-x-xqgmro:0.05;--un-scale-y-xqgmro:0.05;--un-border-opacity-efwnq4:1;--un-bg-opacity-efwnq4:1;--un-text-opacity-efwnq4:1;}/* layer: shortcuts */
      .uno-pe1esh{transform:translateX(var(--un-translate-x)) translateY(var(--un-translate-y)) translateZ(var(--un-translate-z)) rotate(var(--un-rotate)) rotateX(var(--un-rotate-x)) rotateY(var(--un-rotate-y)) rotateZ(var(--un-rotate-z)) skewX(var(--un-skew-x)) skewY(var(--un-skew-y)) scaleX(var(--un-scale-x-xqgmro)) scaleY(var(--un-scale-y-xqgmro)) scaleZ(var(--un-scale-z));border-width:1px;border-color:rgb(229 231 235 / var(--un-border-opacity-efwnq4));background-color:rgb(239 68 68 / var(--un-bg-opacity-efwnq4));font-size:1.25rem;line-height:1.75rem;font-weight:700;}
      .dark .uno-pe1esh:hover{background-color:rgb(34 197 94 / var(--un-bg-opacity-efwnq4));}
      .uno-cbgd7b{text-align:center;}
      .uno-s9yxer{font-size:0.875rem;line-height:1.25rem;font-weight:700;}
      .uno-s9yxer:hover{color:rgb(248 113 113 / var(--un-text-opacity-efwnq4));}
  ...
  it('custom class name trigger (without class name)', async () => {
    ...
    expect(result.css).toMatchInlineSnapshot(`
      ...
      .uno-trmz0g{background-color:rgb(239 68 68 / var(--un-bg-opacity-efwnq4));font-size:1.25rem;line-height:1.75rem;}"
    `)
  })
  ...
  it('custom class name trigger (with basic class name)', async () => {
    ...
    expect(result.css).toMatchInlineSnapshot(`
      ":root{--un-bg-opacity-efwnq4:1;}/* layer: shortcuts */
      .something-foo{background-color:rgb(239 68 68 / var(--un-bg-opacity-efwnq4));font-size:1.25rem;line-height:1.75rem;}"
    `)
  })
  ...
  it('custom class name trigger (with complex class name)', async () => {
    ...
    expect(result.css).toMatchInlineSnapshot(`
      ":root{--un-bg-opacity-efwnq4:1;}/* layer: shortcuts */
      .uno-foo_bar-baz{background-color:rgb(239 68 68 / var(--un-bg-opacity-efwnq4));font-size:1.25rem;line-height:1.75rem;}"
    `)
  })
