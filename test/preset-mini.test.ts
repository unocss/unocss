...
describe('preset-mini', () => {
  ...
  it('override colors differently', async () => {
    ...
    expect((await uno.generate('bg-blue-400 text-blue-400', { preflights: false })).css)
      .toMatchInlineSnapshot(`
        ...
        .bg-blue-400{background-color:rgb(0 0 400 / var(--un-bg-opacity-efwnq4));}
        .text-blue-400{color:rgb(0 0 700 / var(--un-text-opacity-efwnq4));}"
      `)
  })
  ...
  it('account custom color for shadow theme', async () => {
    ...
    expect((await uno.generate('shadow-[0_2px_10px] shadow-blackA7', { preflights: false })).css)
      .toMatchInlineSnapshot(`
        ":root{--un-shadow-vp4u14:0 2px 10px var(--un-shadow-color);--un-shadow-opacity-u5czuz:0.169;}/* layer: default */
        .shadow-\\[0_2px_10px\\]{box-shadow:var(--un-ring-offset-shadow), var(--un-ring-shadow), var(--un-shadow-vp4u14);}
        .shadow-blackA7{--un-shadow-color:hsla(0, 0%, 0%, var(--un-shadow-opacity-u5czuz));}"
      `)
    expect((await uno.generate('shadow-[0_0_7.5rem_0_var(--shadow)]', { preflights: false })).css)
      .toMatchInlineSnapshot(`
        ":root{--un-shadow-1q82e5:0 0 7.5rem 0 var(--un-shadow-color, var(--shadow));}/* layer: default */
        .shadow-\\[0_0_7\\.5rem_0_var\\(--shadow\\)\\]{box-shadow:var(--un-ring-offset-shadow), var(--un-ring-shadow), var(--un-shadow-1q82e5);}"
      `)

    expect((await uno.generate('shadow-[0_0_7.5rem_0_#000]', { preflights: false })).css)
      .toMatchInlineSnapshot(`
        ":root{--un-shadow-wxwiqj:0 0 7.5rem 0 var(--un-shadow-color, rgb(0 0 0));}/* layer: default */
        .shadow-\\[0_0_7\\.5rem_0_\\#000\\]{box-shadow:var(--un-ring-offset-shadow), var(--un-ring-shadow), var(--un-shadow-wxwiqj);}"
      `)
  })
