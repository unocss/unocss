...
describe('typography with custom theme colors', () => {
  it('with alpha', async () => {
    ...
    expect(css).toMatchInlineSnapshot(`
      "/* layer: typography */
      .prose-myColor{--un-prose-body:oklch(0.49 0.22 0);--un-prose-invert-body:oklch(0.82 0.14 0 / <alpha-value>);--un-prose-headings:oklch(0.36 0.15 0 / <alpha-value>);--un-prose-invert-headings:white;--un-prose-lead:oklch(0.56 0.235 0 / <alpha-value>);--un-prose-invert-lead:oklch(0.73 0.195 0 / <alpha-value>);--un-prose-links:oklch(0.36 0.15 0 / <alpha-value>);--un-prose-invert-links:white;--un-prose-bold:oklch(0.36 0.15 0 / <alpha-value>);--un-prose-invert-bold:white;--un-prose-counters:oklch(0.64 0.24 0 / <alpha-value>);--un-prose-invert-counters:oklch(0.73 0.195 0 / <alpha-value>);--un-prose-bullets:oklch(0.82 0.14 0 / <alpha-value>);--un-prose-invert-bullets:oklch(0.56 0.235 0 / <alpha-value>);--un-prose-hr:oklch(0.88 0.09 0 / <alpha-value>);--un-prose-invert-hr:oklch(0.49 0.22 0);--un-prose-quotes:oklch(0.36 0.15 0 / <alpha-value>);--un-prose-invert-quotes:oklch(0.93 0.05 0 / <alpha-value>);--un-prose-quote-borders:oklch(0.88 0.09 0 / <alpha-value>);--un-prose-invert-quote-borders:oklch(0.49 0.22 0);--un-prose-captions:oklch(0.64 0.24 0 / <alpha-value>);--un-prose-invert-captions:oklch(0.73 0.195 0 / <alpha-value>);--un-prose-kbd:oklch(0.36 0.15 0 / <alpha-value>);--un-prose-invert-kbd:white;--un-prose-kbd-shadows:oklch(0.36 0.15 0 / <alpha-value>);--un-prose-invert-kbd-shadows:white;--un-prose-code:oklch(0.36 0.15 0 / <alpha-value>);--un-prose-invert-code:white;--un-prose-pre-code:oklch(0.88 0.09 0 / <alpha-value>);--un-prose-invert-pre-code:oklch(0.82 0.14 0 / <alpha-value>);--un-prose-pre-bg:oklch(0.41 0.185 0 / <alpha-value>);--un-prose-invert-pre-bg:rgb(0 0 0 / 50%);--un-prose-th-borders:oklch(0.82 0.14 0 / <alpha-value>);--un-prose-invert-th-borders:oklch(0.56 0.235 0 / <alpha-value>);--un-prose-td-borders:oklch(0.88 0.09 0 / <alpha-value>);--un-prose-invert-td-borders:oklch(0.49 0.22 0);}"
    `)
  })
})
