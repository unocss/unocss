  ...
  it('should provide autocomplete', async() => {
    expect(
    ...
    ).toMatchInlineSnapshot(`
      {
        ...
        "border": "border border-collapse border-separate border-spacing",
        "border-": "border-0 border-1 border-2 border-3 border-4 border-5 border-6 border-8 border-10 border-12",
        "border-r": "border-r border-rd border-red border-revert border-ridge border-rose border-rounded",
