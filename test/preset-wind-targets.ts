export const presetWindiTargets: string[] = [
  ...
  'bg-gradient-shapes-t',
  'bg-gradient-shapes-tl',
  'bg-gradient-shapes-[70deg]',
  'bg-gradient-shapes-[closest-side]',
  'bg-gradient-shapes-[circle_at_70%]',
  'bg-gradient-shapes-[from_40deg]',
  'shapes-tl',
  'shapes-[70deg]',
  'shapes-[farthest-corner_at_0_0]',
  'shapes-[from_3.1416rad_at_10%_50%]',
