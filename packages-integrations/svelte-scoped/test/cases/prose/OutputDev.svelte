  ...
  *,
  ...
  :global(._uno-prose_y3ob9x) {
    ...
    :where(kbd):not(
      ...
      box-shadow: 0 0 0 1px rgb(var(--un-prose-kbd-shadows) / 10%),
        0 3px 0 rgb(var(--un-prose-kbd-shadows) / 10%);
      font-size: 0.875em;
