...
<style>
  ...
  :global(._scale-5_7dkb0w) {
    transform: translateX(var(--un-translate-x))
      ...
      skewX(var(--un-skew-x)) skewY(var(--un-skew-y))
      scaleX(var(--un-scale-x-xqgmro)) scaleY(var(--un-scale-y-xqgmro))
  ...
  :global(.dark ._dark\:hover\:bg-green-500_7dkb0w:hover) {
    background-color: rgb(34 197 94 / var(--un-bg-opacity-efwnq4));
  }
  ...
  :global(._text-orange-400_7dkb0w) {
    color: rgb(251 146 60 / var(--un-text-opacity-efwnq4));
  }
  :global(._hover\:text-red_7dkb0w:hover) {
    color: rgb(248 113 113 / var(--un-text-opacity-efwnq4));
  }
