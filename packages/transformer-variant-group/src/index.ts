...
import { defaultVariantGroupSeparators, parseVariantGroup } from '@unocss/core'
...
export default function transformerVariantGroup(
  ...
  return {
    ...
    enforce: 'pre',
    transform(s) {
      const result = parseVariantGroup(s, options.separators || [...defaultVariantGroupSeparators, '!', ''])
      return {
