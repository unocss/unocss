...
const preflightKeys = Object.keys(borderSpacingBase)
...
export const tables: Rule<Theme>[] = [
  ...
  }, { preflightKeys, autocomplete: ['border-spacing', 'border-spacing-$spacing'] }],
  ...
  }, { preflightKeys, autocomplete: ['border-spacing-(x|y)', 'border-spacing-(x|y)-$spacing'] }],
