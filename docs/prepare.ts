...
copyFileSync(
  '../packages/preset-attributify/README.md',
  'presets/attributify.md',
)
copyFileSync('../packages/preset-web-fonts/README.md', 'presets/web-fonts.md')
copyFileSync(
  '../packages/preset-typography/README.md',
  'presets/typography.md',
)
...
copyFileSync('../packages/cli/README.md', 'integrations/cli.md')
