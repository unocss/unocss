...
- [@unocss/preset-uno](/guide/preset/uno) - The default preset.
- [@unocss/preset-wind](/guide/preset/wind) - Tailwind / Windi CSS compact preset.
- [@unocss/preset-mini](/guide/preset/mini) - The minimal but essential rules and variants.
- [@unocss/preset-attributify](/guide/preset/attributify) - Provides [Attributify Mode](https://github.com/unocss/unocss/tree/main/packages/preset-attributify#attributify-mode) to other presets and rules.
- [@unocss/preset-icons](/guide/preset/icons) - Use any icon as a class utility.
- [@unocss/preset-web-fonts](/guide/preset/web-fonts) - Web fonts at ease.
