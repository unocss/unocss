...
| `next` | [GitHub](https://github.com/unocss/unocss/tree/main/examples/next) | [Play Online](https://stackblitz.com/fork/github/unocss/unocss/tree/stackblitz-examples/examples/next) | Error: fails to load SWC binary for @next/swc-linux |
...
| `qwik` | [GitHub](https://github.com/unocss/unocss/tree/main/examples/qwik) | [Play Online](https://stackblitz.com/fork/github/unocss/unocss/tree/stackblitz-examples/examples/qwik) | Error: Cannot find module 'undici' |
| `remix` | [GitHub](https://github.com/unocss/unocss/tree/main/examples/remix) | [Play Online](https://stackblitz.com/fork/github/unocss/unocss/tree/stackblitz-examples/examples/remix) | Info: prints some Remix upgrade notices |
...
| `vite-elm` | [GitHub](https://github.com/unocss/unocss/tree/main/examples/vite-elm) | [Play Online](https://stackblitz.com/fork/github/unocss/unocss/tree/stackblitz-examples/examples/vite-elm) | Broken, learn from https://stackblitz.com/edit/elm-daisyui to make work |
...
| `vite-svelte-postcss` | [GitHub](https://github.com/unocss/unocss/tree/main/examples/vite-svelte-postcss) | [Play Online](https://stackblitz.com/fork/github/unocss/unocss/tree/stackblitz-examples/examples/vite-svelte-postcss) | Vite error: end must be greater than start |
